...
\begin{itemize}
  \item intermediate-energy fibres of size in $(q^{1/3}(\log q)^{-O(1)},q/3)$ (\texttt{inverse-energy.tex}), including thin three-quarters-energy stars that are not exact cylinders and two-cluster configurations with AP-poor supports; medium fibres and exact (AP-support) cylinders pack;
