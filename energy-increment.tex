...
A complete affine interval of uniformly below-random lags does pack
(\texttt{inverse-energy.tex}, Lemma~2ndmoment; Lean
\texttt{pack\_window}); a $\tfrac34$-close in-star on
$\{t+1,\dots,t+L\}$ is such an interval (Lean
...
\begin{enumerate}
  ...
  \item a leftover of intermediate-energy fibres of size in
        ...
        bound, except for that in-star case.
\end{enumerate}
Items (1)--(4) are theorems (no Weyl).
Item (5) is a structure theorem, not a size bound, except for a
$\tfrac34$-close in-interval of uniformly below-random lags:
half-intersection does not beat the random overlap on non-heavy cores,
