...
or is a medium $\tfrac12$-close star whose remaining gap is Weyl,
...
\begin{enumerate}
  ...
  \item a leftover of intermediate-energy fibres of size in
        ...
        $T$-dense $x$ is Weyl (items (1)--(2) of the packing path are
        theorems there). Medium aligned fibres have two-thirds energy
