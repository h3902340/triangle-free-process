...
`R3k-proofs.pdf` — an 18-page guided tour of the proofs behind
...
exchange rate between a construction and a Ramsey constant. Sections 10-15
are the paper. Section 16 is the intuition on one page — the takeaway for
